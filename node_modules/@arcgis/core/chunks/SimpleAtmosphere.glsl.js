...
fragColor = color;
	  ...
	  `),g.uniforms.add(new f("tex",(e=>e.texture))),t||g.uniforms.add(new a("altitudeFade",(e=>e.altitudeFade))),g.code.add(d`
		void main() {
      ...
      `}
    }`)}return o}const h=Object.freeze(Object.defineProperty({__proto__:null,SilhouetteCircle:u,SimpleAtmospherePassParameters:g,build:v},Symbol.toStringTag,{value:"Module"}));export{g as S,h as a,u as b,v as c};
