 ...
 * v1.4.3
 */
import { r as registerInstance, c as createEvent, h, a as getElement, H as Host } from './index-c7e05e63.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-946fb911.js';
import { v as getElementProp, g as getSlotted, b as getElementDir, t as toAriaBoolean, c as closestElementCrossShadowBoundary } from './dom-1fb94ff6.js';
...
const AccordionItem = class {
  ...
  getItemPosition() {
    const { el } = this;
    const items = closestElementCrossShadowBoundary(el, "calcite-accordion")?.querySelectorAll("calcite-accordion-item");
